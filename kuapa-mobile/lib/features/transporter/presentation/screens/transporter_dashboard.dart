        ...
        child: Column(
          ...
          children: [
            ...
            stats.when(
              ...
              data: (s) => Row(
                children: [
                  _StatCard(label: 'Total Trips', value: s['total'].toString(), icon: Icons.route, color: AppTheme.primary),
                  const SizedBox(width: 12),
                  _StatCard(label: 'Delivered', value: s['delivered'].toString(), icon: Icons.done_all, color: AppTheme.primaryLight),
                  const SizedBox(width: 12),
                  _StatCard(label: 'In Transit', value: s['inTransit'].toString(), icon: Icons.local_shipping, color: AppTheme.primary),
                ],
              ),
            ),
